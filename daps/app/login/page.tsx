      ...
      <div className="grid min-h-screen lg:grid-cols-2">
        <div
          className={cn(
            ...
            isDarkMode ? "text-white" : "text-[#1f1f2e]",
          )}
          style={{
            background: isDarkMode
              ? "linear-gradient(135deg, #20134f 0%, #0d1029 100%)"
        ...
        >
          ...
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_70%_70%,rgba(255,255,255,0.1),transparent_44%)]" />
        </div>

        <div className="flex items-center justify-center bg-transparent p-8">
          <div className="w-full max-w-[420px] rounded-2xl border border-foreground/15 bg-background/70 p-6 backdrop-blur-md sm:p-8">
            ...
            <div className="mb-10 text-center">
              ...
              <p className="text-sm text-foreground/70">Please enter your details</p>
            </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    required
                    className="h-12 bg-background/80 pr-10"
                  />
                  <button
                    type="button"
                    onClick={() => setShowPassword(!showPassword)}
                    className="absolute right-3 top-1/2 -translate-y-1/2 text-foreground/60 transition-colors hover:text-foreground"
                  >
            ...
            <div className="mt-6">
              <Button variant="outline" className="h-12 w-full bg-background/60" type="button">
